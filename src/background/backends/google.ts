        ...
        configurable: [
            {
                ...
                type: "password",
                key: "key",
                value: atob("QUl6YVN5RExFZUZJNU90RkJ3WUJJb0tfamo1bTMyclpLNUNrQ1hB"),
            },
        ],
    },
    translate: async (text: string, targetLanguage: string, settings: {key: string}) => {
        const future = fetch(
            "https://translate-pa.googleapis.com/v1/translate?" + [
                ...
                "query.target_language=" + encodeURIComponent(targetLanguage),
        ...
        try {
            ...
            throw `Failed to connect to Google: ${error}`;
        }
        if (!response.ok) {
